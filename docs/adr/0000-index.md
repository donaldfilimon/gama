...
| [0016](0016-native-regions-narrow-own-the-rendering.md) | Native regions: an application-owned view may fill a region Gama lays out, with a mandatory portable fallback; widgets are still not wrapped | Accepted (not built) |
