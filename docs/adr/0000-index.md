...
| [0004](0004-signal-confinement.md) | Signal stays `@unchecked Sendable` under executor confinement; Synchronization is banned in GamaCore | Superseded by 0009 |
...
| [0009](0009-signal-is-not-sendable.md) | Signal is not Sendable; host confinement is compiler-checked | Accepted |
