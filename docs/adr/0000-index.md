...
| [0013](0013-flex-priority-is-per-axis.md) | Flex priority is per-axis; the axis-agnostic public `flexPriority` is advisory pending promotion of the per-axis form or deprecation | Provisional |
