...
/// Windows-specific dialog implementation
#if canImport(WinSDK)
public protocol WindowsDialog {
    /// Show modal dialog
    func showModal(owner: Window?) -> Int32
}

/// Windows dialog box wrapper (basic implementation)
public class WindowsDialog: WindowsDialog {
    private let template: DLGTEMPLATE
    private var controls: [any Control] = []
