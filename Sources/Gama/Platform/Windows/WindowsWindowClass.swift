...
/// Windows-specific window class registration wrapper
#if canImport(WinSDK)
public class WindowsWindowClass {
    ...
    public func register(
        ...
        guard !isRegistered else {
            throw PlatformError.operationFailed(reason: "Window class already registered")
        }
        ...
        guard atom != 0 else {
            ...
            if error != ERROR_CLASS_ALREADY_EXISTS {
                throw PlatformError.fromErrorCode(error)
            }
        }
