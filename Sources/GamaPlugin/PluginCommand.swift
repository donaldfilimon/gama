...
public struct PluginCommand: Sendable {
    ...
    public var action: @Sendable (PluginContext) -> Void

    /// Creates a command contribution.
    public init(
        id: CommandID,
        title: String,
        action: @escaping @Sendable (PluginContext) -> Void
    ) {
        self.id = id
        self.title = title
        self.action = action
...
public struct RegisteredPluginCommand: Sendable {
    ...
    init(plugin: PluginID, id: CommandID, title: String, run: @escaping @Sendable () -> Void) {
        self.plugin = plugin
        self.id = id
        self.title = title
        self.run = run
