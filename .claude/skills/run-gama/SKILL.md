...
`.claude/skills/run-gama/driver.sh`. Paths below are relative to the
...
```bash
.claude/skills/run-gama/driver.sh build      # pinned build of gama-demo
.claude/skills/run-gama/driver.sh launch     # detached tmux session, 100x30
.claude/skills/run-gama/driver.sh text       # print the current frame
.claude/skills/run-gama/driver.sh snap base  # save the frame to a file
.claude/skills/run-gama/driver.sh focus      # label of the focused control
.claude/skills/run-gama/driver.sh count      # the demo's counter value
.claude/skills/run-gama/driver.sh keys Tab   # any tmux send-keys argument
.claude/skills/run-gama/driver.sh quit       # Ctrl-C and kill the session
```
...
```bash
.claude/skills/run-gama/driver.sh mlir
```

## Run: the AppKit app

```bash
.claude/skills/run-gama/driver.sh apple
```
